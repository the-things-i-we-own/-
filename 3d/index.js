var Index = [
    "令和四年版　夏の自由研究 | The Things I (We) Own, in 3D<br/>",
    "2022年8月13日(土) - 16日(火) | ∧° ┐が BnA Alter Museum に滞在し、夏の自由研究を実施します。",
    "① 自分の所有するものを記録するホームページを作る | 所要時間：約2時間半　|　参加費：2500円+税（事前予約制）<br/>",
    "② 所有するものを収納する箱を装飾する | 参加費：1000円+税　|　※予約不要　|　",
    "③ 私（わたしたち）がBnA Alter Museumの周りで聞いた言葉　|　スティッキーアンドペン Think Note プレゼント（先着10名）"
]
